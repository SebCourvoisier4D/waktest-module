exports.format = function(data) {
	...
	_report.push('<testsuites success="' + ((data.passes / (data.passes + data.failures)) * 100).toFixed(2) + '%" completion="' + data.completion + '%" passed="' + data.passes + '" failures="' + data.failures + '" skipped="' + data.skipped + '" tests="' + (data.passes + data.failures + data.skipped) + '" time="' + data.duration + '" path="' + util.encodedStr(data.path) + '">');
